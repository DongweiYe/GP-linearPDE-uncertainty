...
from include.train import train_heat_equation_model_2d, train_heat_equation_model_2d_no
...
import pickle
import os
from include.test_f_infer_function import plot_f_inference
...
def main_h():
    ...
    Y_certain = model_initializer.Y_certain
    print("Y:", Y)
    ...
    #                                                                                    mcmc_text
    #                                                                                    )
    # param_iter = (((jnp.array([96.24751524], dtype=jnp.float64),
    #           jnp.array([0.23486136, 0.10204791], dtype=jnp.float64))),)
